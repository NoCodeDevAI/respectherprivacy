...
export default function ResourcesCardList() {
	...
	return (
		<div id="resources" className="py-8" suppressHydrationWarning>
			{/* Category Tabs */}
			<div className="mb-12 overflow-x-auto hide-scrollbar" suppressHydrationWarning>
				<div className="flex space-x-2 pb-2 min-w-max mx-auto justify-center" suppressHydrationWarning>
			...
			{activeCategory === 'all' && (
				<div className="mb-12" suppressHydrationWarning>
					...
					<div className="grid gap-6 md:grid-cols-2 lg:grid-cols-2" suppressHydrationWarning>
...
function ResourceCard({ resource }: { resource: any }) {
	return (
		<div className="group bg-gray-800/30 backdrop-blur-sm border border-accent-pink/20 p-6 rounded-2xl shadow-sm hover:shadow-xl hover:border-accent-pink/40 transition-all duration-500 transform hover:-translate-y-1 flex flex-col h-full" suppressHydrationWarning>
			...
			{resource.phone && (
				<div className="flex items-center gap-2 mb-4 p-2.5 bg-accent-pink/5 rounded-lg border border-accent-pink/10" suppressHydrationWarning>
...
function FeaturedResourceCard({ resource }: { resource: any }) {
	return (
		<div className="relative group overflow-hidden rounded-2xl border-2 border-accent-pink/30 shadow-lg hover:shadow-xl transition-all duration-500 bg-gradient-to-br from-gray-900/90 to-gray-800/90 backdrop-blur-sm" suppressHydrationWarning>
			<div className="absolute top-0 right-0 bg-accent-pink text-white text-xs font-bold px-3 py-1 rounded-bl-lg" suppressHydrationWarning>
				Priority Resource
			</div>
			...
			<div className="p-6" suppressHydrationWarning>
				...
				{resource.phone && (
					<div className="flex items-center gap-3 mb-6 p-3 bg-white/5 rounded-lg backdrop-blur-sm" suppressHydrationWarning>
